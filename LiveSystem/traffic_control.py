...
def tc_easy_bandwith(**kwargs):
    ...
    os.system("tc class {0} dev lo parent 1: classid 1:11 htb rate {1}mbit ceil {1}mbit".format(op_mode, bw))
    if kwargs['first']:
        os.system("tc filter add dev lo protocol ip parent 1:0 prio 1 u32 match ip dport 0 0x0000 flowid 1:11")
...
def init_argparse():
    ...
    parser.add_argument("-nic", nargs=1, default="lo",
                        metavar="ETHERNET",
